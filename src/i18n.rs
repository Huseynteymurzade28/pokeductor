...
pub struct HelpStrings {
    ...
    /// `B`: mark or unmark the highlighted species as a favourite.
    pub act_favourite: &'static str,
    ...
    /// `fav:`: only the species marked with `B`.
    pub act_by_favourite: &'static str,
...
impl Strings {
    fn english() -> Self {
        Strings {
            ...
            forms_label: "Forms",
            forms_title: " Forms ",
            forms_close_hint: "↑ ↓ Select · Enter Open · Esc / V to close",
            col_learn: "Lv",
            col_move: "Move",
            col_type: "Type",
            col_category: "Cat.",
            ...
            team_close_hint: "↑ ↓ Select · C Pin / compare · Esc / P to close",
            ...
            help_card: HelpStrings {
                ...
                act_favourite: "Mark / unmark favourite",
                ...
                act_by_favourite: "Only favourites",
    ...
    fn turkish() -> Self {
        Strings {
            ...
            total_label: "Toplam",
            egg_groups_label: "Yumurta grupları",
            genderless: "Cinsiyetsiz",
            catch_rate_label: "Yakalama oranı",
            catch_hard: "zor",
            catch_average: "orta",
            catch_easy: "kolay",
            growth_label: "Gelişim",
            happiness_label: "Mutluluk",
            habitat_label: "Yaşam alanı",
            error_prefix: "Hata",
            stat_hp: "CAN",
            stat_attack: "Saldırı",
            ...
            forms_label: "Formlar",
            forms_title: " Formlar ",
            forms_close_hint: "↑ ↓ Seç · Enter Aç · Esc / V Kapat",
            col_learn: "Sv",
            col_move: "Hareket",
            col_type: "Tip",
            col_category: "Tür",
            ...
            team_close_hint: "↑ ↓ Seç · C Sabitle / karşılaştır · Esc / P Kapat",
            ...
            help_card: HelpStrings {
                ...
                ctx_party: "Takım kartı",
                ctx_forms: "Form kartı",
                ...
                act_favourite: "Favorilere ekle / çıkar",
    ...
    fn german() -> Self {
        Strings {
            ...
            forms_label: "Formen",
            forms_title: " Formen ",
            forms_close_hint: "↑ ↓ Wählen · Enter Öffnen · Esc / V Schließen",
            col_learn: "Lv",
            col_move: "Attacke",
            col_type: "Typ",
            col_category: "Kat.",
            ...
            team_close_hint: "↑ ↓ Wählen · C Anheften · Esc / P Schließen",
            ...
            help_card: HelpStrings {
                ...
                act_random: "Zufällig aus der Liste",
                act_party_toggle: "Team hinzu / entfernen",
                act_favourite: "Favorit an / aus",
                act_party_card: "Team",
                act_sort: "Sortierung",
    ...
    fn french() -> Self {
        Strings {
            ...
            weight_label: "Poids",
            total_label: "Total",
            egg_groups_label: "Groupes d'Œuf",
            genderless: "Asexué",
            ...
            forms_label: "Formes",
            forms_title: " Formes ",
            forms_close_hint: "↑ ↓ Choisir · Entrée Ouvrir · Esc / V Fermer",
            col_learn: "Niv",
            col_move: "Capacité",
            col_type: "Type",
            col_category: "Cat.",
            ...
            immunity_maybe: "possible",
            team_close_hint: "↑ ↓ Choisir · C Épingler / comparer · Esc / P Fermer",
            ...
            help_card: HelpStrings {
                ...
                act_favourite: "Ajouter / retirer des favoris",
                ...
                act_by_favourite: "Favoris seulement",
    ...
    fn spanish() -> Self {
        Strings {
            ...
            forms_label: "Formas",
            forms_title: " Formas ",
            forms_close_hint: "↑ ↓ Elegir · Enter Abrir · Esc / V Cerrar",
            col_learn: "Niv",
            col_move: "Movimiento",
            col_type: "Tipo",
            col_category: "Cat.",
            ...
            team_close_hint: "↑ ↓ Elegir · C Fijar / comparar · Esc / P Cerrar",
            ...
            help_card: HelpStrings {
                ...
                act_favourite: "Marcar / quitar favorito",
                ...
                act_by_favourite: "Solo favoritos",
    ...
    fn italian() -> Self {
        Strings {
            ...
            forms_label: "Forme",
            forms_title: " Forme ",
            forms_close_hint: "↑ ↓ Scegli · Invio Apri · Esc / V Chiudi",
            col_learn: "Liv",
            col_move: "Mossa",
            col_type: "Tipo",
            col_category: "Cat.",
            ...
            team_close_hint: "↑ ↓ Scegli · C Fissa / confronta · Esc / P Chiudi",
            ...
            help_card: HelpStrings {
                ...
                act_party_toggle: "Metti / togli in squadra",
                act_favourite: "Metti / togli nei preferiti",
                ...
                act_by_favourite: "Solo preferiti",
