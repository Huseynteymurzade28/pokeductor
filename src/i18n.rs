...
impl Strings {
    fn english() -> Self {
        Strings {
            ...
            stat_speed: "Speed",
            help: " ↑/↓ Navigate · Enter Select · E Evolutions · T Types · Space Team · P Party · S Sort · / Search · L Language · Q Quit ",
    ...
    fn turkish() -> Self {
        Strings {
            ...
            stat_speed: "Hız",
            help: " ↑/↓ Gezin · Enter Seç · E Evrimler · T Tipler · Boşluk Takım · P Takım kartı · S Sırala · / Ara · L Dil · Q Çıkış ",
    ...
    fn german() -> Self {
        Strings {
            ...
            stat_speed: "Tempo",
            help: " ↑/↓ Navigieren · Enter Wählen · E Entwicklung · T Typen · Leer Team · P Teamkarte · S Sortieren · / Suche · L Sprache · Q Beenden ",
            search_hint: "Name · type:water · gen:1",
            sort_dex: "Dex",
            sort_name: "A–Z",
            team_title: " Team ",
    ...
    fn french() -> Self {
        Strings {
            ...
            stat_speed: "Vitesse",
            help: " ↑/↓ Naviguer · Entrée Choisir · E Évolution · T Types · Espace Équipe · P Carte équipe · S Trier · / Recherche · L Langue · Q Quitter ",
    ...
    fn spanish() -> Self {
        Strings {
            ...
            stat_speed: "Velocid.",
            help: " ↑/↓ Navegar · Enter Elegir · E Evolución · T Tipos · Espacio Equipo · P Ficha equipo · S Ordenar · / Buscar · L Idioma · Q Salir ",
    ...
    fn italian() -> Self {
        Strings {
            ...
            stat_speed: "Velocità",
            help: " ↑/↓ Naviga · Invio Scegli · E Evoluzione · T Tipi · Spazio Squadra · P Scheda squadra · S Ordina · / Cerca · L Lingua · Q Esci ",
